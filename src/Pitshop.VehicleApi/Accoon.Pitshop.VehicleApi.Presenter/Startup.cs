...
namespace Accoon.Pitshop.VehicleApi.Presenter
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var connectionString = Configuration.GetConnectionString("VehicleContext").ToString();
            services.AddDbContext<VehicleDatabaseContext>
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Accoon .- Pitshop Vehicle Management API", Version = "v1" });
            });
